...
### FB-010 — Preview date PURPOSE misunderstood; Horizontal Preview escalates to CLSD, not Hosted 🔴 Open
- **Date / reviewer:** 2026-07-21 / Hannah S-K
...
- **Owner action:** Rewrite the preview-availability explanation and add the Horizontal (CLSD) vs Vertical (HS) escalation split. 🔴 Not yet applied.
>>>>>>> 2796e06 (Log FB-010: preview-date purpose corrected; Horizontal Preview escalates to CLSD)
